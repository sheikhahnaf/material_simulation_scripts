...
!  structure for the puckered bismuthene (p-bismuthene). 8 atom types.
   ...
   ! data from first-principles calculations in PRB 94, 014415 (2016). v is
   ! produced by using a3=11.81 from the experiment Phys. Rev. Lett. 93, 105501
   ! (2004). w is the relative distance between two subgroups in the 
   ! top/bottom atomic groups.
   a1 = 2.0 * 4.94_dp
   a2 = 4.55_dp
   a3 = 11.81_dp
   u = 0.0405_dp

...
!  structure for stanene
   ...
   ! structure parameters from Superlattices and Microstructures 91,
   ! 383-390 (2016)
   latconst = 4.68
   h = 0.86
   ! arbitrary value, should be modified for few-layer system
   thickness = 11.81/2.0

   ! derived structural parameters
   a = latconst
   ! bond
   bond = sqrt(h*h+(a/sqrt(3.0))*(a/sqrt(3.0)))

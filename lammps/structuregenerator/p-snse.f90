...
!  structure for p-SnSe    
   ...
   d1 =  2.8870 !r13
   d2 =  2.7300 !r14
   t1 =  1.6144 !theta134 with apex 1
   t2 =  1.6633 !theta425 with apex 4
   ...
   if(orientation.eq.'a')then                                                                          
      ...
      coord(2,6) = 0.0_dp
      coord(3,6) = v * a3
      coord(1,7) = (0.5_dp-u) * a1 + a1
      coord(2,7) = 0.5_dp * a2
      coord(3,7) = (v+w) * a3
      coord(1,8) = (0.5_dp+u) * a1 + a1
      coord(2,8) = 0.5_dp * a2
      coord(3,8) = (-v+w) * a3
      box_x = 2.0*a1
      box_y = a2
   ...
   ! zigzag
      ...
      coord(3,6) = v * a3
      coord(1,7) = 0.5_dp * a2
      coord(2,7) = -(0.5_dp-u) * a1 -a1
      coord(3,7) = (v+w) * a3
      coord(1,8) = 0.5_dp * a2
      coord(2,8) = -(0.5_dp+u) * a1 - a1
      coord(3,8) = (-v+w) * a3
      box_x = a2
      box_y = 2.0*a1
      shift0(1) = 0.5_dp * a2

...
!  structure for buckled antimonene (b-antimonene)
   ...
   ! structure parameters from arxiv:1604.03422v1
   bond = 2.89
   latconst = 4.12
   ! thickness is not found for bulk beta-arsenene, should be modified
   thickness = 5.63
